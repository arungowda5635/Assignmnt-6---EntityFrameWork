<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterStudent.aspx.cs" Inherits="EntityFrameWork.RegisterStudent" %>
         ...
         <div class="form-group">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TxtDob"  class="form-control" runat="server"></asp:TextBox></td>
                </tr>
                 <tr>
                <td colspan="2"> <asp:Button ID="BtnRegister" runat="server" Text="Register" Class="btn btn-primary" OnClick="BtnRegister_Click"></asp:Button></td>
